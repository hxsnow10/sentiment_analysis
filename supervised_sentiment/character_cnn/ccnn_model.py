...
def main(save_to='cnn.pkl', num_epochs=10, batch_size=100,
        ...
        rule_path=None, vocab_path='vocab.txt', sen_len=100,# config LookUp_Ruled
        filter_sizes=[(1,100),(2,100),(3,100),(4,100),(5,100),(6,100),(7,100)], num_filters=[100,100,50,50,25,25,25],# config multi_conv
        top_mlp_activations=[Softmax()],top_mlp_dims=[375,3],# config top mlp
        return_model=False    
        ):
